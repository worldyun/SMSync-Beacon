...
CONFIG.SMSYNC = {
    ...
    DEFAULT = {
        ...
        WS_CONFIG = {                        -- WebSocket配置, FWD_CHANNEL为ws时生效
            URL = "ws://hello.world.com/ws", -- WebSocket链接地址
            ACCESS_KEY = "XXXXXXXX",         -- WebSocket访问密钥
        },
        SMS_FWD_LIST = {},                   -- 短信转发目标列表, FWD_CHANNEL为sms时生效
        FWD_ENABLE = false,                  -- 是否启用转发功能
        NET_ENABLE = false,                  -- 是否启用网络功能
        BLACK_LIST = {},                     -- 黑名单列表, 可以为手机号码, 也可以为号码段, 号码段以*结尾, 例如138*, 或者关键字, 以*开头结尾, 例如*测试*
    ...
    WS_CONFIG = {           -- WebSocket配置, FWD_CHANNEL为ws时生效
        URL = nil,          -- WebSocket链接地址
        ACCESS_KEY = nil,   -- WebSocket访问密钥
    },
    SMS_FWD_LIST = {},      -- 短信转发目标列表, FWD_CHANNEL为sms时生效
    FWD_ENABLE = false,     -- 是否启用转发功能
    NET_ENABLE = false,     -- 是否启用网络功能
